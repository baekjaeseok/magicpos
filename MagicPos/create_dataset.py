...
secs_for_action = 10  # 하나의 제스쳐를 찍는데 걸리는 시간

# MediaPipe hands model

# 초기화
mp_hands = mp.solutions.hands # 손 위에 그림을 그릴 수 있는 메소드
mp_drawing = mp.solutions.drawing_utils # MediaPipe solution에서 제공하는 손 모델
...
while cap.isOpened():
    for idx, action in enumerate(actions):
        ...
        # LSTM 모델 사용을 위해 raw 데이터 ---> seq 데이터로 변환
        full_seq_data = []
