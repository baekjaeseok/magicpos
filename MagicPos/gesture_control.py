...
model = load_model('models/LSTM_tanh_seq30.h5')
...
def tospring3():
    ...
    temp = abc
    abc = "unknown"
    print("1번 인식",temp,abc)
    return temp

@app.route("/video_motion2")
def tospring4():
    global abc
    global temp
    temp = "unknown"
